...
describe('blockfrostChainHistoryProvider', () => {
      ...
      redeemers: [
        {
          data: Buffer.from(
            new Uint8Array([
              ...
              49, 99, 98, 53, 100, 97, 52, 50, 98, 53, 98, 51, 55, 49, 56, 53, 101, 48, 99, 56, 97, 53, 50, 54, 49, 52,
              51, 98, 56, 50, 52
            ])
          ),
          executionUnits: {
  ...
  describe('transactionsBy*', () => {
    ...
    beforeEach(() => {
      ...
      provider = new BlockfrostChainHistoryProvider({ blockfrost, logger });
  ...
  describe('transactionsBy* with CBOR', () => {
    const expectedHydratedTxCBOR = {
      ...
      witness: {
        ...
        signatures: new Map([
          [
            '5401b7f67442e6cc870fbcffe921d24ab03e97e03bb655a24b4f424fd832c615',
            '5bddd2f0d88e254ef1f0a84276aaadea4df3b05f8c441d9774b6a8d1c2556437a79e5131ea4475169d45e6e02bb3b31cd93216c5499e2c316aa68e485d680000'
          ]
        ]) // not available in blockfrost
      }
    } as Cardano.HydratedTx;
    let blockfrost: BlockFrostAPI;
    let provider: BlockfrostChainHistoryProvider;
