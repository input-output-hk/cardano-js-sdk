...
import { Cardano, PlutusData } from '@cardano-sdk/core';
...
export const tx: Cardano.Tx = {
  ...
  witness: {
    ...
    redeemers: [
      {
        data: PlutusData.fromCbor(HexBlob('d86682008101')).toCore(),
        executionUnits: {
          memory: 3000,
          steps: 7000
        },
      ...
      {
        data: PlutusData.fromCbor(HexBlob('d86682008102')).toCore(),
        executionUnits: {
          memory: 5000,
          steps: 2000
        },
