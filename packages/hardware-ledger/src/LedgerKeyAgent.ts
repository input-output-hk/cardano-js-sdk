...
const parseNodeHidDevicePathOrDeviceParam = (
  communicationType: CommunicationType,
...
export class LedgerKeyAgent extends KeyAgentBase {
   ...
   * @throws TransportError
   */
  static async establishDeviceConnection(communicationType: CommunicationType): Promise<LedgerConnection>;
  ...
  static async establishDeviceConnection(
    ...
    const { device, nodeHidDevicePath } = parseNodeHidDevicePathOrDeviceParam(
      communicationType,
