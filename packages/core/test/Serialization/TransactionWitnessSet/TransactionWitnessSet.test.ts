...
const simpleWitnessCborWithSets = HexBlob(
  ''
);
...
describe('TransactionWitnessSet', () => {
  it('can encode TransactionWitnessSet to CBOR (tag 258 sets and map redeemers by default)', () => {
    const witness = TransactionWitnessSet.fromCore(core);
    expect(witness.toCbor()).toEqual(cborWithSets);
  });
  ...
  it('can encode simple TransactionWitnessSet to CBOR (vkeys emit tag 258 set by default)', () => {
    const witness = TransactionWitnessSet.fromCore(simpleCore);
    expect(witness.toCbor()).toEqual(simpleWitnessCborWithSets);
  });
