import { Asset, CML, Cardano, cmlToCore, coreToCml } from '../../../src';
...
describe('NftMetadata.fromPlutusData', () => {
  ...
  it('can convert AdaHandle datum', () => {
    ...
    const datum = usingAutoFree((scope) => {
      const cmlTxOut = coreToCml.txOut(scope, {
      ...
      return cmlToCore.txOut(cmlTxOut).datum!;
    });
