...
import { signature, tx, txBody, txInWithAddress, txOut, valueCoinOnly, valueWithAssets, vkey } from './testData';
...
describe('coreToCsl', () => {
  it('txIn', () => {
    expect(coreToCsl.txIn(txInWithAddress)).toBeInstanceOf(CSL.TransactionInput);
  });
  it('txOut', () => {
