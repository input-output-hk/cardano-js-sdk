...
export class StakePoolEpochRewards {
  ...
  /** The rewards generated by the pool that leaders have access to up to the current epoch. Incomplete for last two epochs. */
  ...
  /** The rewards generated by the pool that members have access to up to the current epoch. Incomplete for last two epochs. */
