...
export class CertificateFactory {
  ...
  public poolRetirement(poolKeyHash: Ed25519KeyHashBech32, epoch: number) {
  ...
  public stakeDelegation(delegatee: Ed25519KeyHashBech32) {
  ...
  private createCslRelays(relays: Relay[]) {
