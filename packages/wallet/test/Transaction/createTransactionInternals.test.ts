...
describe('Transaction.createTransactionInternals', () => {
  ...
  it('converts csl types from selection result to core', async () => {
    const props = {
      ...
      scriptIntegrityHash: Hash32ByteBase16('3e33018e8293d319ef5b3ac72366dd28006bd315b715f7e7cfcbd3004129b80d')
    };
    ...
    expect(txInternals.body.scriptIntegrityHash).toEqual<Hash32ByteBase16>(props.scriptIntegrityHash);
